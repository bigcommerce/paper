 ...
 */
internals.loadHelpers = function (context) {
    ...
    Handlebars.registerHelper('form', function(formContext){
            var formPartialPath = formContext.partial;

        switch(formContext.type) {
            case 'singleline':
                return internals.renderPartial(formPartialPath, formContext);
            case 'password':
                return internals.renderPartial(formPartialPath, formContext);
            case 'singleselect':
                return internals.renderPartial(formPartialPath, formContext);
