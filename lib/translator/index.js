...
Translator.prototype.translate = function (key, parameters) {
    if (parameters.language && parameters.language.length && this._language !== parameters.language) {
		this._language = Transformer.transform(this._allTranslations, [parameters.language], this._logger) || {};
	}
